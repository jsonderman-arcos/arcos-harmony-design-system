...
export const themeOptions: ThemeOptions = {
  ...
  "components": {
    ...
    "MuiCheckbox": {
      "styleOverrides": {
        "root": {
          "color": "var(--theme-base-text-primary, rgba(0,0,0,0.56))",
          "& .MuiSvgIcon-root": {
            "color": "inherit"
          },
          "&:hover": {
          ...
          "&.MuiCheckbox-colorSecondary": {
            "color": "var(--theme-base-secondary-main, rgba(156,39,176,1))",
            "&.Mui-checked, &.MuiCheckbox-indeterminate": {
              "color": "var(--theme-base-secondary-main, rgba(156,39,176,1))"
            },
            "&:hover": {
              "backgroundColor": "var(--theme-base-secondary-states-hover, rgba(156,39,176,0.04))"
            }
          },
          "&.MuiCheckbox-colorError": {
            ...
            "&:hover": {
              "backgroundColor": "var(--theme-base-feedback-error-states-hover, rgba(211,47,47,0.08))"
            }
          },
          "&.MuiCheckbox-colorWarning": {
            ...
            "&:hover": {
              "backgroundColor": "var(--theme-base-feedback-warning-states-hover, rgba(237,108,2,0.08))"
            }
          },
          "&.MuiCheckbox-colorInfo": {
            ...
            "&:hover": {
              "backgroundColor": "var(--theme-base-feedback-info-states-hover, rgba(2,136,209,0.08))"
            }
          },
          "&.MuiCheckbox-colorSuccess": {
            ...
            "&:hover": {
              "backgroundColor": "var(--theme-base-feedback-success-states-hover, rgba(46,125,50,0.08))"
            }
          }
        }
      }
